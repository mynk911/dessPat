...
{
    int A[] = {19, 14, 15, 6, 12, 5, 17, 6, 18, 10, 15,
               20, 18, 9, 10, 14, 20, 14,
               15, 21, 6, 9, 18, 19, 18, 4, 4, 19, 9, 12, 17,
               21, 14, 12, 4, 12, 18, 21, 15, 5, 4,
               18, 19, 4, 21, 17, 15, 5, 14, 17, 19, 21,
               20, 16, 21, 10, 9, 9, 12,
               5};
    int res[60];
    size_t res_size;
    int a = sorting_array_elements_by_frequency(A, 60, res, &res_size);
    EXPECT_EQ(a, 0);
    EXPECT_THAT(res, ElementsAre(18, 18, 18, 18, 18, 18,
                                 21, 21, 21, 21, 21, 21,
                                 4, 4, 4, 4, 4,
                                 9, 9, 9, 9, 9,
                                 12, 12, 12, 12, 12,
